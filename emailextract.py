...
# Suppress SSL warnings when using a proxy with a self-signed cert (e.g. Burp Suite)
...
# Optional proxy argument for traffic interception (e.g. --proxy http://127.0.0.1:8080)
parser.add_argument("--proxy", dest="proxy",
                  help="Proxy URL for traffic interception (e.g. http://127.0.0.1:8080)", metavar="PROXY", type=str, default=None)
...
# Route traffic through proxy if specified; disable SSL verification for self-signed certs
if PROXY:
